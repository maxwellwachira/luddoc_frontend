...
import { PrintButton, ExcelButton, PdfButton, AddButton } from '../../features/courses';
import TopicsTable from '../../features/courses/components/topicsTable/topicsTable';
    ...
    return (
        <>
            ...
            <Container mt={40}>
                ...
                <Text weight={600} size={28} my="lg" color={`${colors.secondaryColor}`} align="center">    {props?.courseContent[0].courseTitle}</Text>
                <Grid gutter={50}>
                    <Grid.Col md={7}>
                ...
                <Text weight={600} size={28} my="xl" color={`${colors.secondaryColor}`} align="center">Course Topics</Text>
                <Paper mt={20}  p={10}>
                    <Grid>
                        <Grid.Col md={8}>
                            <Center>
