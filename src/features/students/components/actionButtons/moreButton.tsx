    ...
    return (
        <>
            <Modal
                ...
                onClose={onClose}
                size="500px"
                title={<Text weight={600} color={`${colors.secondaryColor}`} size={25} >{type === "student" ? "Student" : "Tutor"} Details</Text>}
            >    
                <Divider />
                <Container>
                    ...
                    <Group mt="lg" position="apart">
                        <Text><IconReceipt size={16} color={`${colors.secondaryColor}`}/> {type === "student" ? "Student" : "Tutor"} Name: </Text>
                        <Badge color="dark" size="lg">{userData?.firstName} {userData?.lastName}</Badge>
                    </Group>
                    <Group mt="lg" position="apart">
                        <Text><IconPhone size={16} color={`${colors.secondaryColor}`}/> Phone Number: </Text>
                        <Badge color="dark" size="lg">{userData?.phoneNumber}</Badge>
                    </Group>
                    <Group mt="lg" position="apart">
                        <Text><IconMail size={16} color={`${colors.secondaryColor}`}/> Email: </Text>
                        <Badge color="dark" size="lg">{userData?.email}</Badge>
                    </Group>
                    <Group mt="lg" position="apart">
                        <Text><IconActivity size={16} color={`${colors.secondaryColor}`}/> Active: </Text>
